...
// ─── Reorder APIs ──────────────────────────────────
export async function reorderUnits(ordered_ids) {
  await api.put('/categories/units/reorder', ordered_ids);
}
export async function reorderFaultCategories(ordered_ids) {
  await api.put('/categories/fault-categories/reorder', ordered_ids);
}
export async function reorderStatuses(ordered_ids) {
  await api.put('/categories/statuses/reorder', ordered_ids);
}
export async function reorderContractorUnits(ordered_ids) {
  await api.put('/contractor-units/reorder', ordered_ids);
}
export async function reorderLocations(unit_id, ordered_ids) {
  await api.put('/categories/locations/reorder', { unit_id, ordered_ids });
}
