  ...
  return (
    <div className="p-4">
      ...
      <div className="space-y-3">
        ...
        <div className="card">
          <h3 className="text-sm font-semibold text-gray-600 mt-1 mb-2">故障描述</h3>
          <p className="text-gray-800 whitespace-pre-wrap">{order.fault_description}</p>
        </div>

        {/* Row 3: Handling Method */}
        {order.handling_method && (
          <div className="card">
            <h3 className="text-sm font-semibold text-gray-600 mt-1 mb-2">處理方式</h3>
