...
export default function LocationSettings({ items, units, onAdd, onUpdate, onDelete, onReorderInUnit }) {
    ...
    <div className="space-y-3">
      ...
      {items.length === 0 ? (
        ...
        <div className="space-y-2">
          {items.map((item) => (
            <div key={item.id} className="card flex flex-col sm:flex-row sm:items-center justify-between gap-3 py-2 px-3">
              {renderItem(item)}
            </div>
          ))}
        </div>
